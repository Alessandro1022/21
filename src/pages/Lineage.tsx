...
import { Crown, ExternalLink, Calendar, X, ArrowLeft } from “lucide-react”;
...
// Textfärg på dynasty-badge — vit fungerar på alla guld/röda bakgrunder i både ljust och mörkt läge
...
const backLabel  = { sv: “Tillbaka”,            en: “Back”,              tr: “Geri”               }[language] ?? “Back”;
...
```
      <div className="mb-4">
        {/* BUGG 4: Tillbaka-knapp */}
        <button
          onClick={() => navigate(-1)}
          className="flex items-center gap-1.5 text-xs font-sans text-muted-foreground hover:text-foreground transition-colors mb-3 group"
        >
                ...
                <div className="mt-1 mb-2 animate-fade-in">
                  <div className="bg-card/90 backdrop-blur-md rounded-xl ottoman-border p-4 shadow-xl">
                    ...
                    <div className="space-y-1.5 mb-3">
                      ...
                      {/* Dynasty badge — vit text fungerar på alla guld/röda nyanser */}
                      <div
