...
export default function Badges() {
  ...
  return(
    <div className="main-scroll" style={{minHeight:'100vh',background:C.bg,fontFamily:"'Raleway',sans-serif",color:C.cream,position:'relative'}}>
      ...
      <div style={{maxWidth:1100,margin:'0 auto',padding:'2.5rem 1.5rem 5rem',position:'relative',zIndex:1}}>
