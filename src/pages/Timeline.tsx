        ...
        <div ref={scrollRef} className="flex-1 overflow-y-auto px-4 pb-6 pt-4">
          {selected ? (
            ...
            <div className="max-w-3xl mx-auto animate-fade-in">
              <div className="bg-card backdrop-blur-md rounded-2xl ottoman-border p-5 sm:p-6 space-y-4">
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <h2 className="text-lg sm:text-xl font-serif text-foreground dark:text-foreground">{selected.title[language] || selected.title.en}</h2>
                  </div>
                ...
                <p className="text-sm font-sans text-foreground dark:text-foreground/90 leading-relaxed">{selected.summary[language] || selected.summary.en}</p>
                ...
                <div className="animate-fade-in" style={{ animationDelay: "150ms" }}>
                  ...
                  <div className="bg-secondary/50 rounded-xl p-4 ottoman-border">
                    <p className="text-sm font-sans text-foreground dark:text-foreground/80 leading-relaxed">{selected.consequences[language] || selected.consequences.en}</p>
                  </div>
                </div>
                ...
                <div className="animate-fade-in" style={{ animationDelay: "250ms" }}>
                  ...
                  <div className="bg-primary/5 rounded-xl p-4 ottoman-border">
                    <p className="text-sm font-sans text-foreground dark:text-foreground/80 leading-relaxed">{selected.impact[language] || selected.impact.en}</p>
                  </div>
                </div>
                        ...
                        >
                          ...
                          <div className="flex items-start justify-between gap-3">
                            <div className="flex-1 min-w-0">
                              ...
                              <h3 className="text-sm font-serif text-foreground dark:text-foreground group-hover:text-primary transition-colors truncate">
                                {event.title[language] || event.title.en}
                              </h3>
                              <p className="text-xs font-sans text-muted-foreground dark:text-muted-foreground line-clamp-2 mt-0.5 leading-relaxed">
